...
> Legacy Notice: Archon Beta uses HTTP polling with ETag caching for live updates. This page documents the previous Socket.IO approach and is kept for historical reference.
