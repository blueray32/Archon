...
> Note: Socket.IO examples are legacy; prefer testing HTTP endpoints and polling behavior (ETag 304 vs 200) for live updates.
...
async def mcp_server():
    ...
    from src.mcp_server.mcp_server import ArchonMCPServer
