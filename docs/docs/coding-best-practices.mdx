...
> Note: This document contains legacy Socket.IO guidance. Archon Beta now uses HTTP polling with ETag caching for live updates. See the Polling & Caching guide.
